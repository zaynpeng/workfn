---
name: zayn-route
description: 分析复杂职场问题，复用已有证据，判断应先使用哪个 Skill，并规划调用顺序、参数传递、停止条件和下一步业务动作；覆盖客户、报价、订单、售后、内部协作、市场与商业情报等场景。也用于完整销售开发、市场研究或客户筛选任务中的 NETWORKMAP 路由，以及公司跨行业、主体、地区、时间或研究边界不清时的前置消歧。
---
# ROUTE() Skill 路由与编排
