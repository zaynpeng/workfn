...
| 询价与报价 | zayn-alternative | ALTERNATIVE() | 替代方案 | 对比原需求与替代方案的差异和风险 | Draft for testing | P2 |
| 询价与报价 | zayn-availability | AVAILABILITY() | 货源与库存判断 | 规范现货、可调货、预计可供等库存状态 | Draft for testing | P3 |
| 询价与报价 | zayn-condition | CONDITION() | 成色判断 | 规范全新、拆机、翻新、二手等成色表达 | Draft for testing | P3 |
...
| 订单与交付 | zayn-order-kickoff | ORDER_KICKOFF() | 订单启动协调 | 订单确认后组织多部门完成启动确认和责任分工 | Draft for testing | P0 |
| 投诉与售后 | zayn-complaint | COMPLAINT() | 客诉分析 | 先判断事实、证据和责任，再决定如何回复 | Draft for testing | P1 |
| 投诉与售后 | zayn-rma | RMA() | 退换货判断 | 判断是否接受退回以及退换处理方式 | Draft for testing | P3 |
| 投诉与售后 | zayn-responsibility | RESPONSIBILITY() | 责任边界 | 避免在事实未确认前承担不必要责任 | Draft for testing | P2 |
| 投诉与售后 | zayn-solution | SOLUTION() | 售后方案 | 对比维修、换货、退款、补发等方案 | Draft for testing | P3 |
...
| 内部协作 | zayn-report | REPORT() | 汇报 | 检查汇报目标、进展、证据、风险和下一步 | Draft for testing | P3 |
...
| 产品理解与技术判断 | zayn-product-brief | PRODUCT_BRIEF() | 产品速览 | 基于型号、描述、截图和已有资料，整理产品用途、关键规格、采购关注点和信息缺口 | Draft for testing | P1 |
